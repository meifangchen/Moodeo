...
export default class MoodeoLonely2Screen extends React.Component {
  state = {
    ...
    return (
      ...
      .container}>    
        ...
        <View style={styles.buttoncontainer}>
          <AuthButton 
            onPress={() => {this.props.navigation.push('MoodeoLonely1Screen');}}>Next video
          </AuthButton>
        </View>
      </View> 
    );
